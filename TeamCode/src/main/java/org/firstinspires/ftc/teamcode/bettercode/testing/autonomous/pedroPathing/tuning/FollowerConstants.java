package org.firstinspires.ftc.teamcode.bettercode.testing.autonomous.pedroPathing.tuning;
...
import org.firstinspires.ftc.teamcode.bettercode.testing.autonomous.pedroPathing.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.bettercode.testing.autonomous.pedroPathing.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.bettercode.testing.autonomous.pedroPathing.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    private static double xMovement = 67.23219545799243;
    private static double yMovement = 49.731490472177974;
    ...
    public static double mass = 15.87573;
    ...
    public static double forwardZeroPowerAcceleration = -42.796045690469875;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -93.02354436845093;

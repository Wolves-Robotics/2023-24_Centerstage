package org.firstinspires.ftc.teamcode.bettercode.testing.autonomous.pedroPathing.localization.localizers;
...
import org.firstinspires.ftc.teamcode.bettercode.testing.autonomous.pedroPathing.localization.Encoder;
import org.firstinspires.ftc.teamcode.bettercode.testing.autonomous.pedroPathing.localization.Localizer;
import org.firstinspires.ftc.teamcode.bettercode.testing.autonomous.pedroPathing.localization.Matrix;
...
import org.firstinspires.ftc.teamcode.bettercode.testing.autonomous.pedroPathing.util.NanoTimer;
...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.002945507989122692;
    public static double STRAFE_TICKS_TO_INCHES = 0.002940068536476692;
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(0.6875, -1.375, 0);
        strafeEncoderPose = new Pose(-0.1875, -3.75, Math.toRadians(90));
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "frontRight"));
